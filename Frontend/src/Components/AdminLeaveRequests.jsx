...
const AdminLeaveRequests = () => {
  ...
  return (
    <div style={{ padding: '30px', width: '100%', boxSizing: 'border-box', fontFamily: "'Inter', sans-serif" }}>
      
      {/* 4 Stats Cards */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '30px' }}>
        <div style={{ background: '#fff', padding: '25px', borderRadius: '12px', border: '1px solid #f1f5f9', display: 'flex', gap: '20px', alignItems: 'center' }}>
          <div style={{ background: '#eff6ff', width: '55px', height: '55px', borderRadius: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#3b82f6', fontSize: '22px' }}><i className="far fa-envelope"></i></div>
          <div><h2 style={{ margin: 0, fontSize: '24px' }}>{stats.total}</h2><span style={{ fontSize: '13px', color: '#64748b' }}>Total Requests</span></div>
        </div>
        <div style={{ background: '#fff', padding: '25px', borderRadius: '12px', border: '1px solid #f1f5f9', display: 'flex', gap: '20px', alignItems: 'center' }}>
          <div style={{ background: '#fff7ed', width: '55px', height: '55px', borderRadius: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#f59e0b', fontSize: '22px' }}><i className="far fa-clock"></i></div>
          <div><h2 style={{ margin: 0, fontSize: '24px' }}>{stats.pending}</h2><span style={{ fontSize: '13px', color: '#64748b' }}>Pending</span></div>
        </div>
        <div style={{ background: '#fff', padding: '25px', borderRadius: '12px', border: '1px solid #f1f5f9', display: 'flex', gap: '20px', alignItems: 'center' }}>
          <div style={{ background: '#dcfce7', width: '55px', height: '55px', borderRadius: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#10b981', fontSize: '22px' }}><i className="far fa-check-circle"></i></div>
          <div><h2 style={{ margin: 0, fontSize: '24px' }}>{stats.approved}</h2><span style={{ fontSize: '13px', color: '#64748b' }}>Approved</span></div>
        </div>
        <div style={{ background: '#fff', padding: '25px', borderRadius: '12px', border: '1px solid #f1f5f9', display: 'flex', gap: '20px', alignItems: 'center' }}>
          <div style={{ background: '#fee2e2', width: '55px', height: '55px', borderRadius: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#ef4444', fontSize: '22px' }}><i className="far fa-times-circle"></i></div>
          <div><h2 style={{ margin: 0, fontSize: '24px' }}>{stats.rejected}</h2><span style={{ fontSize: '13px', color: '#64748b' }}>Rejected</span></div>
        </div>
      </div>

      <div style={{ background: '#fff', borderRadius: '12px', padding: '30px', border: '1px solid #f1f5f9' }}>
